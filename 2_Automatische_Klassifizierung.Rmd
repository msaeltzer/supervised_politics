...
Wie können wir einem Text entnehmen, worum es geht?



Diese Aufgabe besteht darin, Text zu kategorisieren. Ein Modell macht Vorhersagen für jeden Text, in welche Kategorie er fällt. Wenn Sie 2 Kategorien haben, wird es versuchen, jeden Text in diese 2 Kategorien einzuordnen. Um dem Computer beizubringen, wie das geht, müssen wir ihn TRAINIEREN. Training bedeutet, dass wir Daten in ein Modell einspeisen, das dann mit der Bewertung von Merkmalen beginnt. Es versucht GEWICHTE für die Merkmale zu finden.
...
Grundsätzlich gibt es 4 Arten:
  ...
  „Minimal Supervision“: Minimaler exogener Input, um spezifische Muster zu identifizieren
...
Nachdem wir gelernt haben, wie man Daten für die Textanalyse aufbereitet und ein sehr einfaches Wörterbuch anwendet, werden wir heute lernen, wie man Text mithilfe von vorbeschrifteten Daten automatisch klassifiziert. Dies ist eine wichtige Unterscheidung.
...
Um diese Fragen zu beantworten, müssen wir die Ergebnisse sorgfältig untersuchen.

Der zentrale Grund, warum Themenmodelle und Korrespondenzanalyse keine Themen oder Dimensionen von Interesse für den Datensatz wiedergewinnen, ist, dass die Auflösungen über politische Themen hinaus oft geospezifisch sind.
...
Was wäre nun, wenn wir die Worte, die wir aus dem anderen Modell gelernt haben, auf den Twitter Corpus übertragen würden?
