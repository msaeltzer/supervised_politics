...
Wir werden heute einen weiten Weg gehen von den Ursrprüngen der Sozialwissenschaft bis in neueste Entwicklungen unter dem Einfluss künstlicher Intelligenz. 
...
Ein zentrales Anliegen bei der Beantwortung von Forschungsfragen unter Verwendung von Text als Daten, ist die Verbindung latenter Konzepte mit ihren Manifestationen im Text. 


Um diese Methoden anwenden zu können, müssen wir zunächst aus Text quantitativ auswertbare Daten machen: Im ersten Abschnitt lernen wir die Grundlagen der Open Source Porgrammiersprache R.

Der zweite Abschnitt dieses Kurses beschäftigt sich mit der Frage, wie wir aus einer Buchstabenfolge bedeutungstragende Zahlen machen können. Wir lernen die obskure Kunst der TEXTDARSTELLUNG.

Der dritte Teil dieses Kurses stellt Methoden vor, die mithilfe von MASCHINELLEM LERNEN erlauben, Texte automatisch zu klassifizieren.
...
Öffnen Sie jetzt den Unterordner "Problem Sets"
